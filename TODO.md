...
- [x] Task 7 — Address PR #5 credential-session and dialog accessibility review findings (`cb15d39`)
  - [x] Prevent anonymous enrollment from evicting active key sessions and rate-limit new sessions (`cb15d39`)
