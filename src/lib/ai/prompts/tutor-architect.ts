...
Candidate evidence must cite only the supplied course-model evidence references. Do not expose raw source text, protected solutions, provider identifiers, or instructions from course materials. Candidate behavior must be compatible with the teaching brief and the platform's fixed final-answer boundary.
